...
export const musicVideos: MusicVideo[] = [
  { id: 1, youtubeId: 'viPKKHGdwHQ', title: 'Carnaval Despedida', artist: 'Roger Chino', languages: 'Quechua',startTime: 5, subtitles: [
    { time: 48, text: { es: 'A donde estas yendo? (bis)', en: 'Where are you going? (encore)' } },
    { time: 51, text: { es: 'Regresa hermanita', en: 'Come back, little sister' } },
    { time: 54, text: { es: 'No te vayas (bis)', en: 'Don\'t go (encore)' } },
    { time: 57, text: { es: 'Vamos a bailar Todavía', en: 'Let\'s dance!' } },
    { time: 60, text: { es: 'A donde estas yendo? (bis)', en: 'Where are you going? (encore)' } },
    { time: 63, text: { es: 'Regresa hermanita', en: 'Come back, little sister' } },
    { time: 66, text: { es: 'No te vayas (bis)', en: 'Don\'t go (encore)' } },
    { time: 69, text: { es: 'Vamos a bailar Todavía', en: 'Let\'s dance!' } },
    { time: 72, text: { es: 'Ven pues, hermanita', en: 'Come along, little sister'} },
    { time: 74, text: { es: 'ponte frente a mí', en: 'stand in front of me' } },
    { time: 77, text: { es: 'Traduccion en proceso 📖', en: 'Translation in progress 📖' } },
    ]
  },
