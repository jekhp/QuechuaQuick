...
export const musicVideos: MusicVideo[] = [
  ...
  { id: 11, youtubeId: '7dci-GAE550', title: 'Carnaval Chunbivilcano', artist: 'Veronica Ccompi', languages: 'Quechua', startTime: 26, subtitles: [
    { time: 47, text: { es: 'Vamos a encontrarnos, vamos a reunirnos', en: 'Let’s meet, let’s gather' }},
    { time: 49, text: { es: 'Solterito de Chumbivilcas', en: 'single man from Chumbivilcas'}},
    { time: 51, text: { es: 'Vamos a encontrarnos, vamos a reunirnos', en: 'Let’s meet, let’s gather' }},
    { time: 54, text: { es: 'Solterito de poncho rojo', en: 'Single man in a red poncho'}},
    { time: 57, text: { es: 'Aqui aqui ya estoy viniendo', en: 'I\'m coming here.'}},
    { time: 59, text: { es: 'Cargando el carnaval', en: 'Loading the carnival'}},
    { time: 61, text: { es: 'Aqui aqui ya estoy viniendo', en: 'I\'m coming here.'}},
    { time: 64, text: { es: 'Jalando el carnaval', en: 'Pulling the carnival'}},
    { time: 66, text: { es: '🎶', en: '🎶'}},
    { time: 68, text: { es: 'Yo estoy viniendo', en: 'I\'m coming'}},
    { time: 70, text: { es: 'señorita vivaz y solita', en: 'I\'m coming'}},
    { time: 73, text: { es: 'Yo estoy viniendo', en: 'I\'m coming'}},
    {time: 75, text: { es: 'joven y solita', en: 'I\'m coming'}},
    {time: 77, text: { es: 'En el pueblo de Chumbivilcas', en: 'I\'m coming'}},
    {time: 80, text: { es: 'Una vieja como zorrillo, sombra sucia', en: 'I\'m coming'}},
    {time: 82, text: { es: 'En el pueblo de Chumbivilcas', en: 'I\'m coming'}},
    {time: 84, text: { es: 'Un viejo como zorro, sombra sucia', en: 'I\'m coming'}},
    {time: 87, text: { es: '🎶', en: '🎶'}},
    {time: 110, text: { es: 'Yo soy solterita', en: '🎶'}},
    {time: 112, text: { es: 'Que besa a todo los jovenes', en: '🎶'}},
    {time: 115, text: { es: 'Yo soy jovencita dulce', en: '🎶'}},
    {time: 117, text: { es: 'Que tumba a todos los jovenes', en: '🎶'}},
    {time: 119, text: { es: 'Quienes son estos', en: '🎶'}},
    {time: 121, text: { es: 'Que no pueden con los jovenes', en: '🎶'}},
    {time: 124, text: { es: 'Quienes son estos', en: '🎶'}},
    {time: 126, text: { es: 'Que no pueden con los jovenes', en: '🎶'}},
    {time: 129, text: { es: '🎶', en: '🎶'}},
    {time: 131, text: { es: 'Solterito de Chumbivilcas', en: '🎶'}},
    {time: 133, text: { es: 'Vamos vamos hay que irnos', en: '🎶'}},
    {time: 136, text: { es: 'Solterito de Qolquemarca', en: '🎶'}},
    {time: 138, text: { es: 'Vamos vamos hay que irnos', en: '🎶'}},
    {time: 140, text: { es: 'Conmigo no mas hagamos pareja', en: '🎶'}},
    {time: 142, text: { es: 'Conmigo no mas nos acompañaremos', en: '🎶'}},
    {time: 145, text: { es: 'aunque sea bajo la lluvia hagamos pareja', en: '🎶'}},
    {time: 147, text: { es: 'incluso con granizo sigamos juntos', en: '🎶'}},
    {time: 150, text: { es: '🎶', en: '🎶'}},
    {time: 173, text: { es: 'Hasta al joven de Chumbivilcas', en: '🎶'}},
    {time: 175, text: { es: 'De su papá le estoy repartiendo', en: '🎶'}},
    {time: 177, text: { es: 'Hasta al joven de Qolquemarca', en: '🎶'}},
    {time: 179, text: { es: 'De su mamá le estoy separando', en: '🎶'}},
    {time: 182, text: { es: 'Del cerro donde esta la apacheta', en: '🎶'}},
    {time: 184, text: { es: 'Riendome estoy pasando ya el cerro', en: '🎶'}},
    {time: 187, text: { es: 'Hasta al joven de Qolquemarca', en: '🎶'}},
    {time: 189, text: { es: 'Riendome me lo estoy robando', en: '🎶'}},
    {time: 192, text: { es: '🎶', en: '🎶'}},
    {time: 194, text: { es: '🎶', en: '🎶'}},
    {time: 196, text: { es: 'Bailando le he dado vuelta', en: '🎶'}},
    {time: 199, text: { es: '🎶', en: '🎶'}},
    {time: 201, text: { es: 'Filmando le he dado vuelta', en: '🎶'}},
    {time: 203, text: { es: 'Al joven de chumbivilcas', en: '🎶'}},
    {time: 206, text: { es: 'Llorando le estoy llevando', en: '🎶'}},
    {time: 208, text: { es: 'A su mamá y papá', en: '🎶'}},
    {time: 210, text: { es: 'Les deje llorando', en: '🎶'}},
    {time: 212, text: { es: '🎶', en: '🎶'}},
  ]},
  ...
  { id: 28, youtubeId: 'J4FZ9Tpeuqg', title: 'Cabra Q\'aracha', artist: 'Gualberto Apaza', languages: 'Quechua',startTime: 50, subtitles: [
    {time: 52, text: { es: 'Por ser pobre, por ser humilde', en: 'I\'m coming'}},
    {time: 55, text: { es: 'Te hice dormir en el cuero de la cabra', en: 'I\'m coming'}},
    {time: 58, text: { es: 'Por ser pobre, por ser humilde', en: 'I\'m coming'}},
    {time: 60, text: { es: 'Te hice dormir en el cuero de la cabra', en: 'I\'m coming'}},
    {time: 64, text: { es: 'El cuero de la cabra', en: 'I\'m coming'}},
    {time: 65, text: { es: 'Tampoco era mio', en: 'I\'m coming'}},
    {time: 66, text: { es: 'Es lo que me preste de mi vecina', en: 'I\'m coming'}},
    {time: 69, text: { es: 'De mi vecina', en: 'I\'m coming'}},
    {time: 70, text: { es: 'Tampoco es', en: 'I\'m coming'}},
    {time: 71, text: { es: 'Es lo que se presto de la asienda', en: 'I\'m coming'}},
    {time: 74, text: { es: '🎶', en: '🎶'}},
    {time: 99, text: { es: 'De la asienda', en: 'I\'m coming'}},
    {time: 100, text: { es: 'Tampoco es', en: 'I\'m coming'}},
    {time: 102, text: { es: 'Lo que lo quitaron del hervajero', en: 'I\'m coming'}},
    {time: 105, text: { es: 'De la asienda', en: 'I\'m coming'}},
    {time: 106, text: { es: 'Tampoco es', en: 'I\'m coming'}},
    {time: 107, text: { es: 'Es lo que se prestaron del hevajero', en: 'I\'m coming'}},
    {time: 110, text: { es: 'Del hervajero', en: 'I\'m coming'}},
    {time: 111, text: { es: 'Tampoco es', en: 'I\'m coming'}},
    {time: 112, text: { es: 'Es lo que le quito del zorrito', en: 'I\'m coming'}},
    {time: 116, text: { es: 'Del hervajero', en: 'I\'m coming'}},
    {time: 117, text: { es: 'Tampoco es', en: 'I\'m coming'}},
    {time: 118, text: { es: 'Es lo que le quito del zorrito', en: 'I\'m coming'}},
    {time: 120, text: { es: '🎶', en: '🎶'}},
    {time: 146, text: { es: 'Por tu carita no mas', en: '🎶'}},
    {time: 147, text: { es: 'Te estoy rondando', en: '🎶'}},
    {time: 150, text: { es: 'Por tu ojos negros', en: '🎶'}},
    {time: 151, text: { es: 'Te estoy mirando', en: '🎶'}},
    {time: 153, text: { es: 'Te estoy rondando', en: '🎶'}},
    {time: 156, text: { es: 'Por tu carita no mas', en: '🎶'}},
    {time: 157, text: { es: 'Te estoy rondando', en: '🎶'}},
    {time: 160, text: { es: 'Por tu ojos negros', en: '🎶'}},
    {time: 161, text: { es: 'Te estoy mirando', en: '🎶'}},
    {time: 163, text: { es: 'Te estoy rondando', en: '🎶'}},
    {time: 166, text: { es: '🎶', en: '🎶'}},
